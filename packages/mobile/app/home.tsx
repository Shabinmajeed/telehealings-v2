    ...
    <View style={styles.container}>
      ...
      <Animated.View style={[styles.topSection, slideFade(headerAnim)]}>
        ...
        {showUserDropdown && (
          <View style={styles.userDropdown}>
            <TouchableOpacity style={styles.dropdownItem} onPress={() => { setShowUserDropdown(false); router.push('/profile' as any); }}>
              <Icon d={ICONS.profile} size={18} color="#1a293b" strokeWidth={2.2} />
              <Text style={styles.dropdownText}>My Profile</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.dropdownItem, styles.dropdownLogout]} onPress={() => { setShowUserDropdown(false); router.push('/'); }}>
      ...
      <View style={styles.bottomNav}>
        <View style={styles.navRow}>
          ...
          <TouchableOpacity style={styles.navItem} onPress={() => router.push('/care' as any)}>
          ...
          <TouchableOpacity style={styles.navItem} onPress={() => router.push('/discover' as any)}>
...
const styles = StyleSheet.create({
  ...
  bottomNav: {
    ...
    shadowOpacity: 0.05, shadowRadius: 24, elevation: 8, zIndex: 10,
  },
  ...
  navSpacer: { width: 70 },
  navCenterAbsolute: {
    position: 'absolute', left: '50%', top: -20, transform: [{ translateX: -30 }], zIndex: 15,
  },
  navCenterBtn: {
