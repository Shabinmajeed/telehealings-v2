  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      ...
      <View style={styles.topSection}>
        ...
        {/* Curved bottom edge — white SVG that covers the gradient bottom */}
        <Svg
          height={30}
          width="100%"
        ...
        >
          <Path
            d={`M0 30 L0 0 Q${SCREEN_WIDTH / 2} 30 ${SCREEN_WIDTH} 0 L${SCREEN_WIDTH} 30 Z`}
            fill="#ffffff"
          />
        </Svg>
      </View>
...
const styles = StyleSheet.create({
  ...
  statBox: {
    backgroundColor: 'rgba(255, 255, 255, 0.9)', borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.5)',
    borderRadius: 16, paddingVertical: 20, paddingHorizontal: 12, flex: 1,
    alignItems: 'center', justifyContent: 'center',
    boxShadow: '0px 10px 30px rgba(0, 0, 0, 0.04)', elevation: 2,
  },
  ...
  ctaButton: {
    backgroundColor: '#387bd5', width: 64, height: 64, borderRadius: 32,
    alignItems: 'center', justifyContent: 'center',
    boxShadow: '0px 4px 12px rgba(56, 123, 213, 0.18)', elevation: 4,
  },
